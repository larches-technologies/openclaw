...
- **[cantonese-ai](/plugins/reference/cantonese-ai)** (`@openclaw/cantonese-ai-speech`) - included in OpenClaw. Adds media understanding provider support. Adds text-to-speech provider support.
